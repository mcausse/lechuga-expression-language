...
public class ExpressionTokenizer {
    ...
    public TokenIterator<Token> tokenize(String sourceFile, String text, int line, int column) {
        return new TokenIterator<>(tokenizeAsList(sourceFile, text, line, column));
    }

    protected List<Token> tokenizeAsList(String sourceFile, String text, int line, int column) {
